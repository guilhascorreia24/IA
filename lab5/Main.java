...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        /*
         * Algoritmo.Population I = new Algoritmo.Population(sc.nextInt(),
         * sc.nextInt()); List<Double> fitnesses = new ArrayList<>(); while
         * (sc.hasNext()) { fitnesses.add(sc.nextDouble()); } I.setFitnesses(fitnesses);
        ...
        /* Algoritmo.Individual parent1 = new Algoritmo.Individual(sc.next());
         ...
         /* 
         * // M System.out.print(Algoritmo.uniformCrossover(parent1, parent2));
         * 
         * // N double pm = Double.parseDouble(sc.next());
         * 
         * Algoritmo.Individual parent3 = new Algoritmo.Individual(sc.next());
         * System.out.println(Algoritmo.bit_flip_mutation(parent3, pm));
         * 
         * // O
         * 
